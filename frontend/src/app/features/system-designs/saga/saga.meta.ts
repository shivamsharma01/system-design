...
export const SAGA_META: DesignMeta = {
  slug: 'saga',
  title: 'Saga Pattern',
  tagline:
  ...
  technologies: ['Kafka', 'Temporal', 'Axon', 'Spring State Machine'],
  difficulty: 'advanced',
  readingTimeMin: 15,
  status: 'published',
  keywords: ['choreography', 'orchestration', 'compensating transaction', '2PC alternative'],
