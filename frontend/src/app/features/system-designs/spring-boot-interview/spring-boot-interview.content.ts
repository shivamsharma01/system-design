      ...
      blocks: [
        {
          type: 'markdown',
          value:
            'A deduplicated Spring Boot question bank covering request flow, IoC, persistence, transactions, security, observability, and production architecture. Questions progress from framework fundamentals to architect-level scenarios.',
        },
        {
          type: 'callout',
          variant: 'tip',
          title: 'Strong answer structure',
          body: 'Explain the **Spring abstraction**, the **internal mechanism** (proxy, filter chain, bean lifecycle, or auto-configuration), one **failure mode**, and how you would **observe it in production**.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. What happens internally when a REST API request reaches Spring Boot?
...
10. How do you validate request payloads?`,
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. How would you trace a request across multiple Spring Boot microservices?
...
18. How would you debug an application that is slow only in production?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. Why does @Transactional sometimes not work?
...
14. How does Spring use proxies for transaction management?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. An IoC-based production system fails intermittently under peak traffic. How do you investigate and redesign it?
2. Traffic grows 10× and the current IoC design becomes a bottleneck. What changes first?
...
18. How do you deploy a new Spring Boot version with zero downtime?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. How does Spring Boot decide which auto-configuration to apply?
...
19. What are common Spring Boot performance mistakes?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. What is Dependency Injection?
...
8. How do you perform graceful shutdown for in-flight requests?`,
        },
      ],
    },
  ],
