      ...
      blocks: [
        {
          type: 'markdown',
          value:
            'A deduplicated Java interview question bank ordered from fundamentals to production scenarios. Answers will be added after the smaller technology sections are complete.',
        },
        {
          type: 'callout',
          variant: 'tip',
          title: 'How to practise',
          body: 'Give a **30-second definition**, explain the **trade-off**, then add a **production example**. For troubleshooting questions, structure the answer as: observe → isolate → verify → fix.',
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. What is the difference between Heap and Stack memory?
...
15. What tools do you use for JVM performance analysis?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. What problem does the Factory Pattern solve?
...
14. Which design patterns are most commonly used in microservices?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. What is the Java Memory Model (JMM)?
...
20. What is Optional and when should it be avoided?`,
        },
      ],
    },
    {
      ...
      blocks: [
        {
          type: 'markdown',
          value: `1. An API works for 100 users but times out at 10K while CPU is 40%. Why?
...
22. One downstream API becomes slow. How do you prevent thread exhaustion?`,
        },
      ],
    },
  ],
