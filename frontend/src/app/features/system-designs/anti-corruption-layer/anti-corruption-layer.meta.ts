...
export const ANTI_CORRUPTION_LAYER_META: DesignMeta = {
  ...
  tags: ['anti-corruption-layer', 'ddd', 'legacy', 'integration', 'adapter'],
  technologies: ['Spring Boot', 'Apache Camel', 'GraphQL BFF', 'REST adapters'],
  difficulty: 'advanced',
  readingTimeMin: 14,
  status: 'published',
  keywords: ['ACL', 'domain boundary', 'legacy integration', 'translation layer'],
