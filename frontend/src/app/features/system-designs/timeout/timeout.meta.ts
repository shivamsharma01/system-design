...
export const TIMEOUT_META: DesignMeta = {
  slug: 'timeout',
  ...
  tags: ['timeout', 'cloud', 'resilience', 'latency', 'hld'],
  technologies: ['Java', 'HTTP Clients', 'gRPC'],
  difficulty: 'beginner',
  readingTimeMin: 11,
  status: 'published',
  keywords: ['deadline', 'socket timeout', 'request timeout', 'cascading failure'],
