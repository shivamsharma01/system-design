...
export const LRU_CACHE_LLD_META: DesignMeta = {
  slug: 'lru-cache-lld',
  ...
  tags: ['lru-cache', 'lld', 'hashmap', 'linked-list', 'caching', 'concurrency'],
  technologies: ['Java', 'HashMap', 'LinkedHashMap', 'ConcurrentHashMap'],
