...
export const LAMBDA_ARCHITECTURE_META: DesignMeta = {
  ...
  tags: ['lambda', 'batch', 'streaming', 'analytics', 'big-data'],
  technologies: ['Apache Spark', 'Kafka', 'Hadoop', 'Cassandra'],
  difficulty: 'advanced',
  readingTimeMin: 14,
  status: 'published',
  keywords: ['batch layer', 'speed layer', 'serving layer', 'Nathan Marz', 'stream processing'],
