...
export const PRODUCER_CONSUMER_META: DesignMeta = {
  ...
  tags: ['producer-consumer', 'concurrency', 'queue', 'lld', 'backpressure'],
  technologies: ['Java', 'BlockingQueue', 'Kafka'],
  difficulty: 'intermediate',
  readingTimeMin: 13,
  status: 'published',
  keywords: ['bounded buffer', 'blocking queue', 'backpressure', 'pipeline'],
