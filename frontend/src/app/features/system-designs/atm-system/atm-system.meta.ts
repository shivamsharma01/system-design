...
export const ATM_SYSTEM_META: DesignMeta = {
  slug: 'atm-system',
  ...
  tags: ['lld', 'state-machine', 'oop', 'banking', 'strategy-pattern', 'chain-of-responsibility'],
  technologies: ['Java', 'OOP', 'State Pattern', 'Strategy Pattern'],
