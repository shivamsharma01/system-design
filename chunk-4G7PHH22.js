...
}`},{type:"markdown",value:"**Seat locking \u2014 the core concurrency-safe primitive.** Two implementations: an in-memory version for a single JVM, and a Redis-based version for a multi-instance deployment."},{type:"code",language:"java",filename:"SeatLockManager.java",code:`public interface SeatLockManager {
